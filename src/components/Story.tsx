...
const LINES = [
  'Povestea noastră începe într-un sat din Moldova, unde livezile umpleau aerul cu arome dulci — de vișină și de zmeură.',
  ...
  'Transmise din generație în generație, rețetele se bazează pe două ingrediente secrete, transformând fiecare înghițitură într-un elixir al amintirilor.',
  'Astăzi, fiecare sticlă — fie vișinată, fie licoare de zmeură — este o punte între generații, un simbol al rezistenței și al dragostei pentru rădăcini.',
]
